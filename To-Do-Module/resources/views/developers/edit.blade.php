...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">iniLabs Developer</h1>
                </div><!-- /.col -->
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('developers/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="designation" value="{{ $getRecord->designation }}" class="form-control" required placeholder="Enter Region Name">
                                    </div>
                                </div>
                                <div class="form-group row">
